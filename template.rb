...
def add_javascript_react
  ...
  run 'yarn add -D @vitejs/plugin-react-refresh eslint eslint-plugin-react eslint-plugin-tailwindcss eslint-plugin-vue path vite-plugin-full-reload vite-plugin-ruby'
end
